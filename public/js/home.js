...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    uploadFile: function uploadFile() {
      ...
      formdata.append("newfilename", this.newFileName); // console.log(formdata);
    ...
    deleteFile: function deleteFile() {
      ...
      this.$ajax({
        method: "delete",
        url: "/files/".concat(this.Modal.id),
        data: {
          pwd: this.Modal.pwd
        }
      }).then(function (res) {
            ...
            _c("td", [
              _c(
                "button",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.showDeleteModal(index)
                    }
                  }
                },
                [_vm._v("\n                        删除\n                    ")]
                    ...
                    directives: [
                      {
                        ...
                        rawName: "v-model",
                        value: _vm.Modal.pwd,
                        expression: "Modal.pwd"
                      }
                    ],
                    staticClass: "form-control",
                    attrs: { type: "password", placeholder: "下载/删除口令" },
                    domProps: { value: _vm.Modal.pwd },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.Modal, "pwd", $event.target.value)
                      }
                    }
                  })
                ])
      ...
      directives: [
        {
          name: "show",
          rawName: "v-show",
          value: _vm.Modal.ModalStyle.display !== "none",
...
/* harmony import */ var _components_Home_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/Home.vue */ "./resources/components/Home.vue");



vue__WEBPACK_IMPORTED_MODULE_0___default.a.prototype.$ajax = axios__WEBPACK_IMPORTED_MODULE_1___default.a;
new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  render: function render(h) {
    return h(_components_Home_vue__WEBPACK_IMPORTED_MODULE_2__["default"]);
  }
}).$mount("#app");
...
__webpack_require__(/*! D:\eeyes\others\php\pst\resources\js\home.js */"./resources/js/home.js");
module.exports = __webpack_require__(/*! D:\eeyes\others\php\pst\resources\sass\home.scss */"./resources/sass/home.scss");
